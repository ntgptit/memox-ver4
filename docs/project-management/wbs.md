...
| 2.5 | Shell/theme visual verification | Render shell + theme states, compare to canonical shots, file numbered defects | app-bar, theme | 2.4 | Specified | P1 | Yes | Screenshot compare vs `shots/`; 0 unaccepted overflow/clip; defect report filed + resolved | Blocked: waiting for shell/theme render states and the test framework through 2.4; `.../shots/{app-bar,theme}--*.png` | Design | TBD |
