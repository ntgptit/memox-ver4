...
| 2.4 | Shell/theme state matrix + tests | State-matrix fixtures + interaction + a11y tests for shell + theme | app-bar, theme | 2.1, 2.2, 2.3, 0.13, 0.11, DEP-TEST | Specified | P1 | Yes | Every app-bar/theme state tested; testID anchors present; framework required (DEP-TEST) | Depends on 0.13 and DEP-TEST; `.../specs/{app-bar,theme}.md` | Opus + Codex | TBD |
