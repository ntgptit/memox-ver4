...
| 1.6 | Navigation primitives | RN `MxBottomNav`, `MxFab`, `MxSearchDock`, `MxIconButton` | app-bar, dashboard, library | 0.10, 0.11, 1.1, 1.4 | Specified | P0 | No (shared) | Active-item pill + FAB placement match shots; hit areas ≥48px; keyboard/focus states present | `.../components/navigation/*.jsx` | Opus + Design | TBD |
