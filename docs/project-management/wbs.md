...
| 3.2 | Content persistence + repositories | Tables + repositories for decks/subdecks/cards-count/languages; transactional multi-table writes | languages, library, subdeck-list | 0.4, 0.5, 3.1, 0.13, DEP-TEST | Specified | P0 | No (owns schema) | Restart preserves data; multi-table create/move is transactional with rollback test; DB is source of truth | Depends on 0.4/0.5; `.../specs/library.md` | Opus | TBD |
