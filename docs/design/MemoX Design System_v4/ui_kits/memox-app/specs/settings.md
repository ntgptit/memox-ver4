...
> Source of truth: `../_features/settings/Settings.jsx`; reference PNGs `../shots/settings--<state>--<theme>.png` (390×780).
> Verify: `node tool/ui_kit_shots/shoot.mjs settings` (gated by `npm run verify:ui-kit`).
