  ...
  - node: app__body
    ...
    - node: div
      ...
      note: GROUPED "game board" — a tight, fixed block (tall 116px cards = size-xl+space-5, small
        ...
        card games (MC / Recall / Fill), so content lands in the same spot when switching screens
