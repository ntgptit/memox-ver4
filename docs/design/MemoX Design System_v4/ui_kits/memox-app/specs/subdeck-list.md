...
Browse and manage subdecks inside the current deck.

Primary CTA: **Create subdeck**
...
Top → bottom: **nested MxContextualAppBar** → primary content → primary action (Create subdeck).
