# mode-picker — Mode Picker — DOM spec
...
+ style: font:15/600 color:text
+ - node: button
+ id: mode-picker/scope-unlearned
+ mx: ?
+ box:
+ abs: [16,710 358x46]
+ rel: [16,174 358x46]
