...
function TermCard({ state }) {
  return (
    <MxCard node="review/term" style={{ flex: 1, justifyContent: 'center', alignItems: 'center', textAlign: 'center', gap: 'var(--memox-space-3)', padding: 'var(--memox-space-6)' }}>
...
export const TermCard = (window.MemoXReview || {}).TermCard;
