...
- [ ] **KIT-16-04 — Text wrapping, min/max size và action count constraints được định nghĩa.**
...
- [ ] **KIT-16-06 — Không cho phép interactive target lồng trong interactive target trái rule.**
...
Open P0:
Open P1:
Open P2: ISS-KIT-16-04, ISS-KIT-16-06
Open P3:
