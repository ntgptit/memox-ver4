...
- [ ] **KIT-27-01 — Có trigger vào/thoát selection mode; back thoát mode trước navigation.**
  - **Cách kiểm:** VM-09 — enter via all supported triggers and press back.
  - **Evidence mong đợi:** Selection transition recording.
  - **Severity mặc định nếu không đạt:** `P1`

- [ ] **KIT-27-02 — Selected count, select all và indeterminate state phản ánh đúng scope.**
  - **Cách kiểm:** VM-09 + VM-10 — select across visible/filtered items.
  - **Evidence mong đợi:** Count/state evidence.
  - **Severity mặc định nếu không đạt:** `P1`

- [ ] **KIT-27-03 — Bulk bar chỉ xuất hiện khi có selection; zero selected không có enabled action.**
  - **Cách kiểm:** VM-05 + VM-09 — select/deselect last item.
  - **Evidence mong đợi:** Bulk-bar state screenshots.
  - **Severity mặc định nếu không đạt:** `P1`

- [ ] **KIT-27-04 — Bulk destructive nêu số lượng/đối tượng và có cancel-safe behavior.**
  - **Cách kiểm:** VM-09 — open confirm, cancel, confirm.
  - **Evidence mong đợi:** Confirmation flow evidence.
  - **Severity mặc định nếu không đạt:** `P1`

- [ ] **KIT-27-05 — Filter/sort/search thay đổi selection theo rule, không làm hidden selection mơ hồ.**
  - **Cách kiểm:** VM-09 — select then alter query/filter/sort.
  - **Evidence mong đợi:** Selection persistence matrix.
  - **Severity mặc định nếu không đạt:** `P1`

- [ ] **KIT-27-06 — Bulk move/export failure hoặc partial success có feedback và selection recovery.**
...
Open P0:
Open P1: ISS-KIT-27-01, ISS-KIT-27-02, ISS-KIT-27-03, ISS-KIT-27-04, ISS-KIT-27-05, ISS-KIT-27-06
Open P2:
Open P3:
