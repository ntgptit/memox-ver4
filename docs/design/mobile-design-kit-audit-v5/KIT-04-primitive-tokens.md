...
- [ ] **KIT-04-05 — Motion primitives có duration, easing và reduced-motion value rõ.**
...
- [ ] **KIT-04-06 — Primitive token không gắn tên component, screen hoặc semantic meaning.**
...
Open P0:
Open P1:
Open P2: ISS-KIT-04-05
Open P3: ISS-KIT-04-06
