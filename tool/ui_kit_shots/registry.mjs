...
export const SCREENS = [
  ...
  { id: 'empty-deck', title: 'Empty Deck', group: 'EmptyDeck',
    ...
    note: 'Content-first (§11): the cards-vs-nested choice lives HERE, after creation. Add card (primary) / Create nested deck / Import cards. Also the state a leaf reaches after its last card, or a parent after its last child, is removed.',
    states: ['default', 'create-nested-dialog', 'import-target'],
    sample: null },
  { id: 'add-card-target', title: 'Add Card · target', group: 'AddCardTarget',
    archetype: 'Selection', objective: 'Pick which deck receives a new card when Add Card is triggered globally.', cta: null,
    note: 'Global Add-Card deck picker (§16). Only leaf + empty decks are selectable; parent decks are disabled with a helper pointing to their nested decks. no-target = nowhere valid yet → Create deck.',
