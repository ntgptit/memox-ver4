...
export const SCREENS = [
  ...
  { id: 'subdeck-list', title: 'Subdeck List', group: 'SubdeckList',
    archetype: 'List', objective: 'Browse and manage subdecks inside the current deck.', cta: 'Create subdeck',
  ...
  { id: 'deck-content-choice', title: 'Deck Content Choice', group: 'DeckContentChoice',
    archetype: 'Detail', objective: 'Decide how a new, empty deck is organised (subdecks vs cards).', cta: null,
