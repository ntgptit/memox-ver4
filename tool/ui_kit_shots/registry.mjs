...
export const SCREENS = [
  ...
  { id: 'library', title: 'Library', group: 'Library',
    archetype: 'List', objective: 'Browse and manage the deck library.', cta: 'Create deck',
    ...
    sample: null },
  { id: 'subdeck-list', title: 'Nested Decks', group: 'SubdeckList',
    archetype: 'List', objective: 'Browse and manage the nested decks inside the current deck.', cta: 'Create deck',
    note: 'Browse and manage the nested decks inside the current deck (no cards). A nested deck is a Deck with parentId set — not a separate model.',
    states: ['loaded', 'dense', 'deep', 'empty', 'search', 'no-results', 'selection', 'create-sheet', 'subdeck-actions', 'long-menu', 'play', 'loading', 'offline', 'error', 'not-found'],
    sample: null },
  ...
  { id: 'deck-content-choice', title: 'Deck Content Choice', group: 'DeckContentChoice',
    archetype: 'Detail', objective: 'Decide how a new, empty deck is organised (nested decks vs cards).', cta: null,
    note: 'Decide how a new, empty deck is organised (nested decks vs cards).',
    states: ['default'],
    sample: null },
